...
agent = the_agent.Agent(possible_actions=[0,2,3],starting_mem_len=50,max_mem_len=750000, starting_epsilon = .5, debug = False)
env = environment.make_env(name,agent)

environment.play_episode(name, env,agent, debug = False)
env.close()
